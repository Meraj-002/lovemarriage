    ...
    <div className="min-h-screen bg-[#fdf7fb]">
      ...
      <main className="px-4 py-6 sm:px-6 sm:py-8 lg:px-8 lg:py-10">
        <div className="mx-auto grid w-full max-w-5xl overflow-hidden rounded-[28px] bg-white shadow-[0_18px_45px_rgba(0,0,0,0.08)] lg:grid-cols-2">
          ...
          <section className="order-1 bg-white px-6 py-8 sm:px-8 sm:py-10 lg:order-2 lg:px-10 lg:py-12">
          ...
          {/* Pink section second on mobile */}
          <section className="order-2 relative overflow-hidden bg-gradient-to-br from-[#f0449f] via-[#ea66b0] to-[#b56ae8] px-6 py-8 text-white sm:px-8 sm:py-10 lg:order-1 lg:px-10 lg:py-12">
